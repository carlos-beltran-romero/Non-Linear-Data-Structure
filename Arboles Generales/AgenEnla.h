//
// Created by carlo on 11/03/2024.
//

#ifndef ARBOLES_GENERALES_AGENENLA_H
#define ARBOLES_GENERALES_AGENENLA_H
#include <cassert>
...
template <typename T>
inline void Agen<T>::insertarHijoIzqdo(Agen::nodo n, const T &e) {
    assert(n!=NODO_NULO);
    nodo aux= n->hizq;
...
inline void Agen<T>::eliminarHermDrcho(nodo n)
{
    ...
    assert(hedrcho->hizq == NODO_NULO); // Hermano drcho. es hoja.// El hermano del hermano se convierte en el
...
#endif //ARBOLES_GENERALES_AGENENLA_H
